...
namespace Traces.ApaleoClients.Integration
{
    ...
    public partial class IntegrationApi : ServiceClient<IntegrationApi>, IIntegrationApi
    {
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<HttpOperationResponse<MessageItemCollection>> IntegrationUiIntegrationsByTargetPostWithHttpMessagesAsync(string target, CreateUiIntegrationModel createUiIntegrationModel, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (target == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "target");
