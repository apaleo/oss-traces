...
namespace Traces.ApaleoClients.Booking.Models
{
    ...
    public partial class OfferCancellationFeeModel
    {
        /// <summary>
        /// Initializes a new instance of the OfferCancellationFeeModel class.
        /// </summary>
        public OfferCancellationFeeModel()
        {
            CustomInit();
        }
        ...
        public OfferCancellationFeeModel(string code, string name, string description, System.DateTime dueDateTime, MonetaryValueModel fee)
        {
            Code = code;
            Name = name;
