...
namespace Traces.ApaleoClients.Booking.Models
{
    ...
    public partial class GroupItemModel
    {
        ...
        public GroupItemModel(string id, string name, System.DateTime created, System.DateTime modified, IList<string> propertyIds, System.DateTime? fromProperty = default(System.DateTime?), System.DateTime? to = default(System.DateTime?), BookerModel booker = default(BookerModel), string comment = default(string), string bookerComment = default(string), PaymentAccountModel paymentAccount = default(PaymentAccountModel), IList<GroupBlockModel> blocks = default(IList<GroupBlockModel>), IList<ActionModelGroupActionNotAllowedGroupActionReason> actions = default(IList<ActionModelGroupActionNotAllowedGroupActionReason>))
        {
            Id = id;
